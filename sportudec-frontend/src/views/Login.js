...
class Login extends Component {
    ...
    render() {
        ...
        const loginVerify = (async () => {
            ...
            const datos = await getFuncionario(this.state.email, this.state.password);
            //El metodo nos retorna 400 (ok), lo demás es error
            if (datos.status !== 400 && datos !== "error") {
                                ...
                                <div className="container container-login login-form">
                                    ...
                                    <form>
                                        ...
                                        <div className='d-flex flex-column justify-content-center align-items-center'>
                                            ...
                                            <div className="pt-3">
                                                <span><a className='link-login'>Iniciar como funcionario</a></span>
                                            </div>
                                        </div>
                                    </form>
                                </div>
